		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h4 class="text-center mb-2">Don't have an account?<a class="btn btn-warning mb-2" href="{{url('/register')}}">Signup</a></h4>
					<form action="{{url('post_login')}}" class="login-form" method="post" id="logForm">
				{{csrf_field()}}
