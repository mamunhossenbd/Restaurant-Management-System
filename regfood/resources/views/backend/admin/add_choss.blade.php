          ...
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">Add Choose</h5>
              </div>
              <div class="card-body">
              <form action="{{route('chosen.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                <div class="row">
                <div class="col-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="icone" class="form-control" id="exampleInputEmail1" placeholder="Enter icon" >
                    </div>
