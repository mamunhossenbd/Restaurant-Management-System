        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
              <form action="{{route('ab.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                <div class="row">
                <div class="col-6">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="experience" class="form-control" id="exampleInputEmail1" placeholder="Enter Offer" >
                    </div>
                    <div class="form-group">
