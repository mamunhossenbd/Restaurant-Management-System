          ...
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">Edit Daily Offer</h5>
              </div>
              <div class="card-body">
              <form action="{{route('daily_offer.update',$data->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="offer" class="form-control" id="exampleInputEmail1" placeholder="Enter Offer" value="{{$data->offer}}">
                    </div>
                    <div class="form-group">
